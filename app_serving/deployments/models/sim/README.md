...
1. Firstly, you should be able to list all helm releases to view all charts that should be installed:
   ...
   gaie-sim     llm-d-sim    1           2026-01-29 10:39:08.317195 -0700 PDT    deployed    inferencepool-v1.2.0        v1.2.0
   infra-sim    llm-d-sim    1           2026-01-29 10:38:48.360829 -0700 PDT    deployed    llm-d-infra-v1.3.6          v0.4.0-rc.1
   ms-sim       llm-d-sim    1           2026-01-29 10:39:15.127738  -0700 PDT    deployed    llm-d-modelservice-0.3.17   v0.4.0-rc.1
   ```
